...
(function main(React, ReactNative, StyleSheet1, responsiveHeight, responsiveFontSize, Header, Footer, Platform, CustomDivider, Loader, LinkField, ListItem,
    ...
    const styles = StyleSheet1.create({
        bottomLayer: {
            flexDirection: 'row',
