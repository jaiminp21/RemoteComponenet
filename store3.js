...
(function main(React, ReactNative, NativeBase, componentState, StyleSheet,
    Dimensions, Loader, navigate, api, require) {
    'use strict';
        ...
        componentState.localStorage.getData("LoginData").then(function (result) {
            ...
            if (result && result.antiForgeryToken) {
                ...
                api.fetchAsync("https://cfsfiserv.com/QEUATSMT/api/Authentication/LogIn","POST",
                    ...
                    localStorage.componentState.saveData("LoginData", loginresult).then(function(result1) {
                    });

                    localStorage.componentState.getData("LoginData").then(function(result1) {
