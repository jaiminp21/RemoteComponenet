(function main(React, ReactNative, componentState, Button, require, styles) {
	...
	return react_1.createElement(reactNative.View, {
		...
		"style": styles.container
			...
			}, "Your user ID and password are used to log in to this site. This page allows you to change your user ID. Your user ID must be between 8 and 26 characters in length and may be made up of both letters and numerals. Your user ID is not case sensitive."),
